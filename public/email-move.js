...
const searchQuery1 = 'from:University';
const searchQuery2 = 'from:Admission';
const searchQuery3 = 'from:Admissions';
const searchQuery4 = 'from:Dean';
    ...
    if (response.resultSizeEstimate > 0) {
      ...
      labelRequest.execute(function(labelResponse) {
        ...
        for (let i = 0; i < response.messages.length; i++) {
          ...
          }, i * 350); // Add a delay of 1 second for each email
        }
      });
    } else {
